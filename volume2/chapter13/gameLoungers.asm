...
LoungersSpriteMax		= 6
LoungersStateWalking		= 0
LoungersStateWaiting		= 1
LoungersStateLying		= 2
LoungersWalkDirLeft		= 1
LoungersWalkDirRight		= 0
LoungersAnimDelay		= 7
LoungersStandingWait		= 7
LoungersLyingWait		= 8
LoungersNoTowel_1_1		= 201
LoungersNoTowel_2_1		= 202
LoungersNoTowel_1_2		= 203
LoungersNoTowel_2_2		= 204
LoungersNoTowel_1_3		= 205
LoungersNoTowel_2_3		= 206
LoungersTowel_1_1		= 207
LoungersTowel_2_1		= 208
LoungersTowel_1_2		= 209
LoungersTowel_2_2		= 210
LoungersTowel_1_3		= 211
LoungersTowel_2_3		= 212
...
gLUSWEndSkip:
	;; Move right 1 so we can try again next frame if no loungers
	;; is available
	inc wLoungersX
...
gLUSWRightWalk:
	...
	;; Add a loungers customer
	inc bHudLoungersCustomers
...
gLUSTowelIsDelivered:
	;; Set the state
	lda #LoungersStateLying
	sta bLoungersState

	;; Remove a loungers customer
	dec bHudLoungersCustomers

	jsr gameHUDDecreaseNumTowels

	;; Set the timer
	lda #LoungersLyingWait
	sta wLoungersTimer+1

	jsr gameHUDIncreaseScore
